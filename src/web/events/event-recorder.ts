...
export class EventRecorder {
    ...
    private registerListeners() {
        this.emitter.on(EventType.PIPELINE_QUEUED, this.onPipelineQueued.bind(this));
        this.emitter.on(EventType.PIPELINE_STARTED, this.onPipelineStarted.bind(this));
        this.emitter.on(EventType.PIPELINE_FINISHED, this.onPipelineFinished.bind(this));
        this.emitter.on(EventType.JOB_QUEUED, this.onJobQueued.bind(this));
        this.emitter.on(EventType.JOB_STARTED, this.onJobStarted.bind(this));
        this.emitter.on(EventType.JOB_LOG_LINE, this.onJobLogLine.bind(this));
        this.emitter.on(EventType.JOB_FINISHED, this.onJobFinished.bind(this));
    }
